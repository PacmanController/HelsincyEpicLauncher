...
internal sealed record FabOwnedRecordSeed(string Namespace, string CatalogItemId, string AppName, DateTimeOffset AcquisitionDate);
...
internal static class FabOwnedFallbackTestData
{
    ...
    public static FabOwnedRecordSeed CreateOwnedRecord(string assetId, int sortIndex)
    {
        return new FabOwnedRecordSeed(
            Namespace: "fab-namespace",
    ...
    public static string CreateCatalogResponse(IEnumerable<string> assetIds)
    {
